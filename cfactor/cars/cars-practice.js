...
window.CARS_PRACTICE=[
{
 id:"restorers-dilemma",
 genre:"Humanities · Art & Aesthetics",
 ...
 questions:[
  {
   stem:"The central thesis of the passage is that restoration is:",
   skill:"Foundations of Comprehension",
   type:"Main Idea",
   choices:[
    "A practice that should be avoided because it always damages the artwork.",
    "An unavoidable act of interpretation that conservators should acknowledge rather than disguise.",
    "Impossible to perform correctly under modern electric lighting.",
    "Most valuable when it returns a painting to the state its artist intended."
   ],
   answer:1,
   why:[
  ...
  {
   stem:"According to the passage, defenders of aggressive cleaning claim that the conservator:",
   skill:"Foundations of Comprehension",
   type:"Detail / Stated Fact",
   choices:[
    "Improves upon the artist's original choice of colors.",
    "Documents every decision for the benefit of future conservators.",
    "Removes only material that the artist did not himself put there.",
    "Restores the painting to the appearance the artist intended."
   ],
   answer:2,
   why:[
  ...
  {
   stem:"The primary function of the third paragraph ('None of this is an argument for neglect …') is to:",
   skill:"Reasoning Within the Text",
   type:"Structure / Function",
   choices:[
    "Concede that the argument could be misread, and narrow the claim accordingly.",
    "Introduce a new objection that the remainder of the passage refutes.",
    "Supply historical evidence in support of the author's thesis.",
    "Withdraw the argument advanced in the preceding paragraphs."
   ],
   answer:0,
   why:[
  ...
  {
   stem:"The author's attitude toward conservators who claim 'only to subtract' is best described as:",
   skill:"Reasoning Within the Text",
   type:"Tone / Attitude",
   choices:[
    "Persuaded by their stated principle of humility.",
    "Indifferent to the consequences of their work.",
    "Openly contemptuous and dismissive.",
    "Skeptical of the claim while respectful of the difficulty it conceals."
   ],
   answer:3,
   why:[
  ...
  {
   stem:"The argument depends on which of the following unstated assumptions?",
   skill:"Reasoning Within the Text",
   type:"Assumption",
   choices:[
    "Renaissance painters anticipated that their works would later be restored.",
    "A painting's identity includes the history of the changes it has undergone.",
    "Most conservators act in bad faith.",
    "Donors and the press are the principal cause of poor restorations."
   ],
   answer:1,
   why:[
  ...
  {
   stem:"The author would most likely approve of a restoration project that:",
   skill:"Reasoning Beyond the Text",
   type:"Application / Extension",
   choices:[
    "Repaints a sculpture in the bright colors scholars believe it originally bore, to reveal its true appearance.",
    "Leaves a deteriorating mural entirely untouched in order to preserve its authenticity.",
    "Uses only reversible materials and publishes a complete record of every intervention.",
    "Strips away all later additions to recover the artist's single intended version."
   ],
   answer:2,
   why:[
 ...
 questions:[
  {
   ...
   choices:[
    "Expose gift-giving as selfishness disguised by warm sentiment.",
    "Argue that gift exchange is a demanding system of obligation rather than the simple opposite of the market.",
    "Recommend that modern societies replace market transactions with gift exchange.",
    "Demonstrate that markets are morally superior to gift economies because they leave no debts."
   ],
   answer:1,
   why:[
    "Distortion. Paragraph 3 explicitly rejects this reading: 'The argument is not that generosity is a disguise for calculation.'",
    "Correct. The passage reframes the gift as 'accounting of another kind' and 'a more demanding species' of exchange that binds people together.",
    "Out of scope. The author analyzes the gift's logic but never recommends replacing markets with it.",
    "Distortion. The author calls the market 'thin' and 'cold'; he does not rank it as morally superior."
   ]
  },
  {
   stem:"According to the passage, a gift that cannot be matched tends to:",
   skill:"Foundations of Comprehension",
   type:"Detail / Stated Fact",
   choices:[
    "Dissolve the relationship between giver and receiver.",
    "Be refused by its intended recipient.",
    "Diminish the recipient and raise the standing of the giver.",
    "Convert the giver into a mere stranger."
   ],
   answer:2,
   why:[
    "Faulty use of detail. It is the market, not the unmatched gift, that lets parties 'walk away owing each other nothing.'",
    "Out of scope. The passage never claims unmatchable gifts are refused.",
    "Correct. Paragraph 2: an unmatchable gift 'leaves its recipient diminished,' while 'the one who gives most is owed most.'",
    "Distortion. Becoming 'strangers' describes the market's effect, not the gift's."
   ]
  },
  {
   stem:"The third paragraph ('It would be a mistake to conclude …') functions chiefly to:",
   skill:"Reasoning Within the Text",
   type:"Structure / Function",
   choices:[
    "Forestall a misreading of the previous paragraph and refine the central claim.",
    "Offer statistical evidence for the obligation to reciprocate.",
    "Concede that the author's thesis has been refuted.",
    "Introduce the market for the first time as a counterexample."
   ],
   answer:0,
   why:[
    "Correct. It blocks the inference that givers are 'merely selfish' and restates the real claim: generosity and obligation 'are not opposites at all.'",
    "Faulty use of detail / out of scope. No statistics appear anywhere in the passage.",
    "Distortion. The author sharpens his thesis here; he does not concede it.",
    "Faulty use of detail. The market is treated at length in paragraph 4, and the contrast is implied earlier; paragraph 3 is about correcting a misreading."
   ]
  },
  {
   stem:"The author's attitude toward the claim that gift-giving is 'pure altruism' is best described as:",
   skill:"Reasoning Within the Text",
   type:"Tone / Attitude",
   choices:[
    "Enthusiastic agreement.",
    "Respectful but ultimately corrective.",
  ...
  {
   stem:"Which assumption is required for the author's contrast between the gift and the market to hold?",
   skill:"Reasoning Within the Text",
   type:"Assumption",
   choices:[
    "Most people prefer giving gifts to making purchases.",
    "An ongoing, unsettled obligation can sustain a social relationship.",
    "Gift economies produce more material wealth than markets do.",
    "Merchants are incapable of forming personal relationships."
   ],
   answer:1,
   why:[
    "Out of scope. The passage makes no claim about people's preferences.",
    "Correct. The argument that the gift 'binds' while the market leaves 'no residue' assumes that a debt left open is what holds people together.",
    "Out of scope. Relative material wealth is never discussed.",
    "Extreme language. The author says the market 'can' move goods between strangers, not that merchants are 'incapable' of relationships."
   ]
  },
  {
   stem:"The author would most likely regard a corporation's no-strings charitable donation, given anonymously, as:",
   skill:"Reasoning Beyond the Text",
   type:"Application / Extension",
   choices:[
    "A perfect example of the binding gift the passage describes.",
    "Proof that gift exchange and market exchange are identical.",
    "Atypical of the gift's logic, since anonymity removes the obligation and relationship the gift normally creates.",
    "Evidence that all giving is ultimately selfish."
   ],
   answer:2,
   why:[
    "Distortion. The binding gift depends on a known giver who can be owed; anonymity removes exactly that.",
    "Out of scope / distortion. The passage draws a sharp contrast between the two; it never equates them.",
    "Correct. Since the gift binds by creating a traceable obligation, an anonymous, no-strings gift lacks the feature the author treats as central.",
    "Distortion. Paragraph 3 explicitly rejects the 'all giving is selfish' reading."
   ]
  }
 ]
},
{
 id:"tyranny-of-the-turning-point",
 genre:"Humanities · History & Historiography",
 origin:"Original passage. No copyrighted source text is reproduced.",
 ...
 questions:[
  {
   stem:"The central claim of the passage is that turning points in history are:",
   skill:"Foundations of Comprehension",
   type:"Main Idea",
   choices:[
    "Best identified by studying the intentions of the people who lived through them.",
    "Largely products of hindsight that impose a dramatic shape on a diffuse process.",
    "Illusions, since no event ever matters more than any other.",
    "Reliable markers that historians discover in the records of the past."
   ],
   answer:1,
   why:[
  ...
  {
   stem:"According to the passage, a battle comes to be called 'decisive' because:",
   skill:"Foundations of Comprehension",
   type:"Detail / Stated Fact",
   choices:[
    "It was recognized as decisive by those who fought in it.",
    "Subsequent events did not reverse its outcome.",
    "It involved larger forces than the clashes around it.",
    "Historians agreed on its importance at the time."
   ],
   answer:1,
   why:[
    "Distortion. The author says decisiveness 'was not a property it possessed on the day.'",
    "Correct. Paragraph 4: 'It earns the adjective only because the events that followed it did not reverse its result.'",
    "Out of scope. Relative size of forces is never mentioned.",
    "Faulty use of detail. The point about hindsight is that the label is 'conferred … later,' not agreed upon at the time."
   ]
  },
  {
   stem:"The third paragraph ('This is not to say that all moments are equal …') primarily serves to:",
   skill:"Reasoning Within the Text",
   type:"Structure / Function",
   choices:[
    "Limit the scope of the argument to prevent an overstated reading.",
    "Abandon the claim made in the first two paragraphs.",
    "Provide documentary evidence for the role of hindsight.",
    "Introduce a rival historian whose view the author endorses."
   ],
   answer:0,
   why:[
  ...
  {
   stem:"The author's tone in discussing histories that rely on turning points is best characterized as:",
   skill:"Reasoning Within the Text",
   type:"Tone / Attitude",
   choices:[
    "Admiring and persuaded.",
    "Hostile and scornful.",
    "Skeptical but understanding of the appeal.",
    "Neutral and uninterested."
   ],
   answer:2,
   why:[
    "Distortion. The author critiques the reliance on turning points; he is not persuaded by it.",
    "Extreme language. He explains the appeal sympathetically ('satisfying because they are legible'); 'scornful' overstates it.",
    "Correct. He doubts the turning point ('distrusts the hinge') yet acknowledges why it is 'satisfying' and 'flattering' to readers.",
    "Out of scope / contradicted. The author is clearly invested, not uninterested."
   ]
  },
  {
   ...
   type:"Weaken",
   choices:[
    "Readers find narratives organized around turning points easier to remember.",
    "Participants in several major events accurately identified, at the time, the moments that would prove decisive.",
    "Most historians prefer to write dramatic, story-driven accounts.",
    "Decisive battles are often commemorated with monuments and holidays."
   ],
   answer:1,
   why:[
  ...
  {
   stem:"The author would most likely agree that an honest account of a scientific breakthrough should:",
   skill:"Reasoning Beyond the Text",
   type:"Application / Extension",
   choices:[
    "Locate the single experiment at which the field changed forever.",
    "Trace the slow, plural causes behind the apparent moment of rupture.",
    "Treat the breakthrough as no more important than any other day's work.",
    "Credit the breakthrough to the foresight of the individual who achieved it."
   ],
   answer:1,
   why:[
    "Distortion. Hunting for a single pivotal instant is exactly the habit the author distrusts.",
    "Correct. Paragraph 5: the honest historian 'treats causes as plural and slow' and 'watches for the long approach behind the apparent rupture.'",
    "Extreme language. The author allows that some events 'carry more weight'; he does not flatten all moments.",
    "Distortion. The author attributes decisiveness to later contingency, not to an individual's foresight."
   ]
  }
 ]
}
